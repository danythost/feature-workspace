...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	if ($rows == 1) {
		...
		?>
			<div class="err">
				<h5>Please Register First Before you can use this feature !!!</h5>
			</div>
...
?>
				...
				<form action="indexMi.php" method="POST" style="margin-bottom: 3%;">
					<input type="text" name="email" placeholder="email address" style="padding: 8px 32px; border: none;">
					<input type="submit" name="subscibe" style="background-color: #206040; font-weight: bold; padding: 8px 32px; color: whitesmoke; cursor: pointer; border: none; margin: 4px 2px;" value="GET ME FREE COURSES">
				</form>
			</div>
		</div>
	</div>
